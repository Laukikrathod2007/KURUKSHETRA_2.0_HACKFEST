...
// 3. Construct Oscilar Hero Section (Image 1)
...
<section class="_landingHero_golzh_1" style="padding-top: 30px; padding-bottom: 70px; position: relative; z-index: 10;">
  <div class="grid-container _heroContainer_golzh_16">
    ...
    <div class="grid-layout" style="align-items: center; gap: 32px;">
      ...
      <!-- Hero Left Column: Oscilar Copy & Headline (Image 1) -->
      ...
      <!-- Hero Right Column: Oscilar Real-Time Dashboard UI Card (Image 1) -->
      <div class="col-6 md:col-6 lg:col-6" style="position: relative; z-index: 20;">
        <div style="background: rgba(255, 255, 255, 0.95); border: 1px solid rgba(0,0,0,0.08); border-radius: 24px; padding: 24px; box-shadow: 0 20px 40px rgba(0,0,0,0.08); backdrop-filter: blur(12px);">
          ...
          <!-- Oscilar Risk Score Dashboard Image -->
...
// 4. Construct Section 2: Institutional Impact (Image 4)
const oscilarTrustHTML = `
<div data-section="animation-2" class="landing-module-logo-wall" data-astro-cid-lcdefpme style="padding: 80px 0; background: #fafafa; border-top: 1px solid rgba(0,0,0,0.06); border-bottom: 1px solid rgba(0,0,0,0.06); position: relative; z-index: 10;">
...
// Replace Section 2
html = html.replace(/<div data-section="animation-2"[\s\S]*?<\/section>\s*<\/div>/i, oscilarTrustHTML);

// 5. Construct Section 3: Unified 3D Layer Stack Architecture (Image 5)
const oscilarUnifiedStackHTML = `
<div data-section="animation-3" class="landing-module-text" data-astro-cid-lcdefpme style="padding: 100px 0; background: #ffffff; position: relative; z-index: 10;">
  <div class="grid-container">
    <div class="grid-layout" style="align-items: center; gap: 32px;">
...
// Replace Section 3
html = html.replace(/<div data-section="animation-3"[\s\S]*?<\/section>\s*<\/div>/i, oscilarUnifiedStackHTML);

fs.writeFileSync('index.html', html, 'utf8');
console.log('Successfully written clean Oscilar landing page with isolated 3D canvas!');
