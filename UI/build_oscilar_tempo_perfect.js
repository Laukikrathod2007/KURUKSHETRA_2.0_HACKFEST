...
// 2. Oscilar Hero (Image 1)
const heroSection = `
<section class="_landingHero_golzh_1" style="padding-top: 40px; padding-bottom: 80px;">
...
// 3. Section 2: Institutional Impact (Image 4)
const trustSection = `
<div data-section="animation-2" class="landing-module-logo-wall" data-astro-cid-lcdefpme style="padding: 80px 0; background: #fafafa; border-top: 1px solid rgba(0,0,0,0.06); border-bottom: 1px solid rgba(0,0,0,0.06);">
  <div class="grid-container">
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 24px;">
      ...
      <div style="background: #0f172a; border-radius: 20px; padding: 32px; color: #fff;">
        ...
        <p style="font-size: 13px; color: #94a3b8; margin-bottom: 24px; line-height: 1.5;">
          SoFi increased processing speed by over 30%
        </p>
      ...
      <div style="background: #0f172a; border-radius: 20px; padding: 32px; color: #fff;">
        ...
        <p style="font-size: 13px; color: #94a3b8; margin-bottom: 24px; line-height: 1.5;">
          Clara boosts client onboarding times by 3x
        </p>
...
// 4. Section 3: Unified 3D Stack Architecture (Image 5)
const unifiedStackSection = `
<div data-section="animation-3" class="landing-module-text" data-astro-cid-lcdefpme style="padding: 100px 0; background: #ffffff;">
  <div class="grid-container">
    <div class="grid-layout" style="align-items: center; gap: 32px;">
      <div class="col-6 md:col-6 lg:col-6">
...
html = html.replace(/<div data-section="animation-2"[\s\S]*?<\/astro-island>\s*<\/section>\s*<\/div>/i, trustSection);
html = html.replace(/<div data-section="animation-3"[\s\S]*?<\/section>\s*<\/div>/i, unifiedStackSection);
