...
## All 36 Features Explained with Exact Banking Protocols, Detection Logic, Zero-Surveillance Privacy Boundaries, and Verification Latency Budgets
...
* **Real-World Quick Scenario (Digital Arrest Playbook):**
  * A victim under pressure from a fake CBI officer prepares to pay ₹60,000.
  ...
  * Seeing the exact script dismantles the scammer's authority. The victim terminates the call.
...
* **Real-World Quick Scenario (Romance / Custom Gift Scam):**
  * A victim is groomed by an online persona who claims to have sent expensive jewelry that is stuck in Delhi airport customs, requiring ₹35,000 clearance.
  * Before confirmation, the app prompts: *"Record a 10-second voice note explaining who this person is and why you are transferring funds."*
  * The victim speaks aloud: *"I am sending ₹35,000 to clear a gift from someone I met on Instagram three weeks ago..."* Hearing the words spoken out loud triggers self-awareness of the absurdity, prompting the victim to abort.
...
* **Real-World Quick Scenario (Post-Call Panic Reversal):**
  * A victim in a state of panic overrides warnings and transfers ₹30,000 for a fake job deposit. The moment the transfer completes, the scammer abruptly disconnects and blocks the victim.
  * The victim realizes they have been defrauded. The payment screen maintains an active timer: **[Tap to Cancel & Recall Funds (12:44 remaining)]**. The victim taps the recall button, halting settlement before the funds leave the settlement buffer.
